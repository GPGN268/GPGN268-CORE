...
##### Task 4 
Count how many lines there are in each of the "A" files and each of the "B" files.
Extra credit: display that in a sorted way (with the number of lines decreasing from the top to the bottom). (Hint: read the [Combining multiple commands](https://gpgn268.github.io/GPGN268-BOOK/filesndir-commandline/#combining-multiple-commands) in the book.)
