...
- Navigate to your `ds01-well-log` directory and launch VSCode. Remember to activate your activate the GPGN268 environement when working in your notebooks.
...
- Using the left navigation toolbar in VSCode, go to the `notebooks` directory and create a new jupyter notebook called `dev.ipynb`– this will be where you will develop the code for your data story (try things out, make draft figures, etc). **You will not** turn in (i.e., push to GitHub) the `dev.ipynb` file. Use the `.gitignore` file.
